...
data['Max_Available_N'] = data['B4_GT41_inWork'] * 150 + data['B4_GT42_inWork'] * 150 + 75*(data['B4_GT41_inWork']+data['B4_GT42_inWork'])
data['target_lag_1'] = data['TEC_N_Aver'].shift(1)
data = data[400:]
...
x = data.loc[:,['T', 'B1_inWork', 'B2_inWork', 'B3_inWork' ,'B4_GT41_inWork', 'B4_GT42_inWork', 'B4_inWork', 'Month_sin', 'Month_cos', 'Year', 'Max_Available_N', 'target_lag_1']]
x = x.values
